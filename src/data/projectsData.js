...
import myImage from "../assets/images/gorgis.png";

export const projectsData = [
  {
    id: 1,
    projectName: "Gorgis Air Conditioning and Heating",
    projectDesc:
      "This project is a real project for a real client which is an eCommerce website  provides installation and repair for the Air conditioning and heating. I have a full-stack roll on this having built all of it..",
    tags: ["PHP", "HTML", "CSS", "Javascript", "MySQL", "Bootstraps"],
    code: "",
    demo: "https://gorgisairheat.com/",
    image: myImage,
  },
  // {
  //     id: 2,
